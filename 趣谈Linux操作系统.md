...
BIOS -> 引导扇区boot.img -> diskboot.img -> lzma_decompress.img 实模式到保护模式、建立分段分页、打开地址线 -> kernel.img 选择一个操作系统 -> 启动系统
...
![下载 (14)](assets/14.jpeg)

### 进程管理

进程在内核中的结构如下所示：

![下载 (17)](assets/17.jpeg)
